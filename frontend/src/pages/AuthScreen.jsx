  ...
  return (
    ...
    <div className="md:flex md:justify-center md:flex-row md:items-center h-screen sm:flex-col">
     ...
     {/* Left Side */}
      ...
      <input type="text" placeholder="Email" className="w-[250px] p-2 mt-10 rounded-xl outline-none border-[2.5px] border-slate-300" />
      <input type="password" placeholder="Password" className="w-[250px] p-2 mt-5 rounded-xl outline-none border-[2.5px] border-slate-300" />
      <button className="w-[90px] p-2 mt-5 rounded-3xl bg-blue-500 text-black">Login</button>
      </div>
      </div>

      {/* Right Side */}
      <div className="md:w-1/2 h-full bg-blue-500 sm:w-full"></div>
    </div>
    </>
  )
}
