import { UsersRoundIcon , MessageCircleMore, Phone  ,Settings} from "lucide-react";
const Sidebar = () => {
  return (
     <>
        ...
        <Settings/>
         ...
         <div className="w-[70px] h-[70px] hover:bg-yellow-300 rounded-full flex items-center justify-center fixed bottom-1">
            <img src="./auth.jpg" alt="" className="w-full h-full rounded-full object-cover" />
         </div>
